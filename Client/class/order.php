...
class Order
{
    ...
    {
        require('../connection.php');
        // return $conn->query("DELETE FROM orders WHERE OrderID = '$orderID'");
    ...
    function addOrder($order)
    {
        ...
        $Date = $order['Date'];
        $Total = $order['Total'];
        $conn->query("INSERT INTO orders (`CustomerID`,`Date`,`Total`) VALUE ('$CustomerID', '$Date','$Total')"); //insert_id=last item id
