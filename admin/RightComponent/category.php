            ...
            <form id="deleteForm" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>Bạn có chắc muốn xóa thể loại này</label>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="card mb-3">
            <div class="card-header">
                <h3><i class="far fa-file-alt"></i> Danh sách thể loại</h3>
                <span><a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal_import_book"><i class="fas fa-plus" aria-hidden="true"></i> Thêm thể loại</a></span>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th style="min-width: 300px">Tên thể loại</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td class="row">
                                        <div class="mt-1">
                                            <span class="bookCate"><?= $row['CategoryID'] ?></span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="pt-1"><?= $row['Name'] ?></div>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-primary btn-sm btn-block" data-toggle="modal" data-target="#exampleModal" onclick="editPublisher('<?= $row['CategoryID'] ?>', '<?= $row['Name'] ?>')"><i class="far fa-edit"></i> Chỉnh sửa</button>
                                        <button type="button" class="btn btn-danger btn-sm  btn-block" data-toggle="modal" data-target="#modal_delete_book" onclick="deletePublisher('<?= $row['CategoryID'] ?>', '<?= $row['Name'] ?>')">
